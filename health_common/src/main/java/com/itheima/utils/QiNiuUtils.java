...
public class QiNiuUtils {
    ...
    private static final String ACCESSKEY = "jVKtyI9bnFdtKbOVUFEMl12DCEsnCmdMBlzV3Edk";
    private static final String SECRETKEY = "9MfkWF3mb10APe9rmnlu3Y4kxeWXIfslY6YNDJvB";
    private static final String BUCKET = "zh104";
    public static final String DOMAIN= "http://qkabarbez.hn-bkt.clouddn.com/";
